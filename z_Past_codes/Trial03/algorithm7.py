...
def train_lotto_model(sequences, num_epochs=25, hidden_size=64, num_layers=2, dropout=0.2, learning_rate=0.001):
    model = LottoLSTM(hidden_size=hidden_size, num_layers=num_layers, dropout=dropout)
